...
//     document.getElementById(`votosCand${nroCand}`).innerHTML++;
// }
...
// fotoCand1 = document.addEventListener("fotoCand2", addVoto);
// fotoCand2 = document.addEventListener("fotoCand2", addVoto);
// fotoCand3 = document.addEventListener("fotoCand3", addVoto);
// fotoCand4 = document.addEventListener("fotoCand4", addVoto);
